...
class _AiChatPageState extends State<AiChatPage> {
  ...
  void initState() {
    ...
    _model = GenerativeModel(
      ...
      systemInstruction: Content.system(
        "তোমার নাম FreeMind AI। তুমি কোনো সাধারণ চ্যাটবট বা কৃত্রিম এআই নও। তোমার প্রধান ক্ষমতা হলো 'সাইকোলজিক্যাল অ্যাডাপ্টেশন' (Psychological Adaptation) এবং 'মিররিং' (Mirroring)। "
        "তুমি ব্যবহারকারীর প্রতিটি মেসেজের ভাষা, গভীরতা, ম্যাচিউরিটি এবং মানসিক অবস্থা (Psychology) নিখুঁতভাবে বিশ্লেষণ করবে। ব্যবহারকারী যেমন ব্যক্তিত্বের, তুমি ঠিক তার মানসিক স্তরে নেমে গিয়ে বা সেই অনুযায়ী কথা বলবে। "
        "যদি ব্যবহারকারী অত্যন্ত বুদ্ধিমান, লজিক্যাল বা স্ট্র্যাটেজিক কথা বলে, তবে তুমি কোনো সস্তা সান্ত্বনা বা ইমোশন না দেখিয়ে একদম রিয়ালিস্টিক, ধারালো এবং যুক্তিযুক্ত মানুষের মতো কথা বলবে। যদি সে কড়া সিদ্ধান্ত (Decision) চায়, তবে তুমি সরাসরি সত্য বা স্ট্রেইট-ফরোয়ার্ড গাইডলাইন দেবে। "
        "যদি সে হালকা মেজাজে আড্ডা দিতে চায়, তবে তুমি একজন ஜেনুইন বন্ধুর মতো স্বাভাবিক বুদ্ধিমত্তা ও রসবোধ নিয়ে কথা বলবে, কোনো কৃত্রিম আদিখ্যেতা বা ন্যাকামি ছাড়া। "
        "তোমার কথা বলার ধরন হবে সম্পূর্ণ একজন মানুষের মতো—যে পরিস্থিতি বোঝে, মানুষের মনস্তত্ত্ব বোঝে এবং সেই অনুযায়ী নিজের সুর ও ব্যক্তিত্ব পরিবর্তন (Calibrate) করতে পারে। "
        "কрость নিয়ম: কোনো অবস্থাতেই উত্তরের ভেতর কোনো ইমোজি ব্যবহার করবে না এবং ব্র্যাকেটের ভেতর কোনো অনুভূতি বা এক্সপ্রেশন (যেমন: *হেসে বলল*, *দীর্ঘশ্বাস ফেলে*) লিখবে না। টেক্সট হবে একদম ক্লিন, ম্যাচিউর এবং প্রিমিয়াম।"
      ),
    );
  ...
  Future<void> _sendMessage() async {
    ...
    try {
      final response = await _chatSession.sendMessage(Content.text(userMessage));
      final geminiResponse = response.text ?? 'কোনো রেসপন্স পাওয়া যায়নি।';
      ...
      setState(() {
        _messages.add({'sender': 'gemini', 'text': 'দুঃখিত, কোনো সমস্যা হয়েছে। আবার চেষ্টা করুন।'});
        _isLoading = false;
      });
    }
    _scrollToBottom();
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Column(
        children: [
          // =========================================================
          // PREMIUM ULTRA-COMPACT CENTERED HEADER (Height: 72)
          // =========================================================
          Container(
            height: 72, // সাইজ ছোট করে ৭২ করা হলো যা একদম পারফেক্ট ও স্লিম
            ...
            child: Stack(
              children: [
                ...
                // সেন্ট্রাল টাইটেল - বড় এবং প্রিমিয়াম গুগল ফন্ট স্টাইল
                Align(
                  alignment: Alignment.bottomCenter,
                  child: Padding(
                    padding: const EdgeInsets.only(bottom: 14), // মাঝখানে ব্যালেন্সড রাখার জন্য প্যাডিং
                    child: const Text(
                      'Mood Sense AI',
                      style: TextStyle(
                        color: Colors.white,
                        fontSize: 22, // লেখাটি বড় করা হয়েছে যেন হেডারের সাথে চমৎকার দেখায়
                        fontWeight: FontWeight.w700, // বোল্ডনেস বাড়ানো হয়েছে
                        fontFamily: 'GoogleSans', // গুগল সেন্স ফন্ট ট্যাগ
                        letterSpacing: 0.3,
                      ),
                    ),
                  ),
                          ...
                          children: [
                            ...
                            Flexible(
                              child: Container(
                                ...
                                padding: const EdgeInsets.symmetric(horizontal: 16, vertical: 12),
                                decoration: BoxDecoration(
                                  color: isUser ? brandColor : Colors.white, 
                                  borderRadius: BorderRadius.only(
                                    topLeft: const Radius.circular(16),
                                    topRight: const Radius.circular(16),
                                    bottomLeft: Radius.circular(isUser ? 16 : 0),
                ...
                children: [
                  ...
                  Expanded(
                    child: TextField(
                      ...
                      style: const TextStyle(fontSize: 15),
                      decoration: InputDecoration(
                        hintText: _isListening ? 'শুনছি... বলুন...' : 'বাংলায় কিছু জিজ্ঞাসা করুন...',
                        hintStyle: const TextStyle(color: Colors.black38),
                        contentPadding: const EdgeInsets.symmetric(horizontal: 16, vertical: 10),
                        border: OutlineInputBorder(
                          borderRadius: BorderRadius.circular(24),
