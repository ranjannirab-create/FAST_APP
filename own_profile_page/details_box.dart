  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      decoration: BoxDecoration(
        ...
        border: Border.all(
          color: primaryColor.withOpacity(0.15), // প্রোফাইল পিকের মতো বর্ডার কালার ও অপাসিটি
          width: 1.5, // সেম বর্ডার উইডথ
        ),
        boxShadow: [
          BoxShadow(
      ...
      child: Column(
        children: [
          ...
          Container(
            ...
            decoration: BoxDecoration(
              color: primaryColor.withOpacity(0.06), // ম্যাচিং পেস্ট গ্রিন ব্যাকগ্রাউন্ড
  ...
  Widget _buildTappableInfoRow(
    ...
    return GestureDetector(
      ...
      child: Padding(
        ...
        child: Row(
          children: [
            Icon(icon, size: 14, color: primaryColor), // আইকন কালার থিমড করা হয়েছে
