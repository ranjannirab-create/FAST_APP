...
class DetailsBox extends StatelessWidget {
  ...
  void _showDetailDialog(BuildContext context, String title, String value, {bool isLocked = false}) {
    showDialog(
      context: context,
      builder: (context) => AlertDialog(
        title: Row(
          children: [
            Icon(isLocked ? Icons.lock_outline : Icons.info_outline, size: 20),
  ...
  Widget _buildTappableInfoRow(
    ...
    return GestureDetector(
      onTap: () => _showDetailDialog(context, title, value, isLocked: isLocked),
      child: Padding(
