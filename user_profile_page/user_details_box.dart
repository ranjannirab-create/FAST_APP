...
class UserDetailsBox extends StatelessWidget {
  ...
  String _getStudyWork() {
    ...
    return userData['workTitle'] ?? 'Not specified';
  }

  // Get hobbies as comma-separated string
  String _getHobbies() {
    final hobbies = userData['hobbies'] as List?;
    if (hobbies == null || hobbies.isEmpty) return 'Not added';
    return hobbies.join(', ');
  }

  // Show detailed dialog (যা আপনার নিজের পেজেও আছে)
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      decoration: BoxDecoration(
        ...
        border: Border.all(
          color: primaryColor.withOpacity(0.15), // সেম বর্ডার অপাসিটি
          width: 1.5,
        ),
        boxShadow: [
          BoxShadow(
            color: primaryColor.withOpacity(0.04), // সেم শ্যাডো ইফেক্ট
            blurRadius: 12,
      ...
      child: Column(
        children: [
          ...
          Container(
            ...
            decoration: BoxDecoration(
              color: primaryColor.withOpacity(0.06), // ম্যাচিং ব্যাকগ্রাউন্ড
            ...
            child: Row(
              children: const [
                ...
                // ফাকা ব্যালেন্স রাখার জন্য একটি আইকন স্পেস (অপশনাল)
                SizedBox(width: 15), 
              ],
            ),
          ),
              ...
              child: Column(
                ...
                children: [
                  ...
                  _buildTappableInfoRow(
                    ...
                    _getAgeDisplay(),
                    primaryColor,
                    isLocked: userData['agePrivacy'] != 'public' && userData['agePrivacy'] != null,
                  ),
                  _buildDivider(),
                  _buildTappableInfoRow(
                    context,
                    ...
                    _getAddressDisplay(),
                    primaryColor,
                    isLocked: userData['addressPrivacy'] != 'public' && userData['addressPrivacy'] != null,
                  ),
                  _buildDivider(),
                  _buildTappableInfoRow(
                    context,
  ...
  Widget _buildTappableInfoRow(
    ...
    return GestureDetector(
      ...
      child: Padding(
        ...
        child: Row(
          children: [
            Icon(icon, size: 14, color: primaryColor), // থিমড আইকন
            const SizedBox(width: 6),
            SizedBox(
              width: 68, // ওন প্রোফাইলের মতো টেক্সট উইডথ ফিক্সড করা হলো
              child: Text(
                title,
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  _buildTappableInfoRow(
                    context,
                    Icons.favorite_outline,  // interest এর জন্য আইকন পরিবর্তন করা হয়েছে
                    'Interest',               // লেবেল 'Hobby' থেকে 'Interest' করা হয়েছে
                    _getInterests(),          // hobbies না হয়ে interests
                    primaryColor,
                  ),
                  _buildDivider(),
                  _buildTappableInfoRow(
